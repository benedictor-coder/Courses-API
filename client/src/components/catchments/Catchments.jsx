...
function Catchments () {
    ...
    //         await fetch('/water-management/api/v1', { method: 'GET', headers: new Headers() })
    ...
    const getCourse = sources.length > 0
        ? sources.map(source => {
    ...
    if (sources === []) {
        return <p className="heading-secondary">Loading list of wells...</p>
    }
    ...
    return (
        <div className="main-page">
            <h1 className="heading-tertiary ">Water Catchments</h1>
            <div className='table-section'>
                <div className="add__data add_water_catchment">
            ...
            <Modal ref={ modalRefEdit }>
                <fieldset>
                    <legend style={ { textAlign: "center" } }><h4 style={ { margin: "0 .5rem" } }>Edit source</h4></legend>
                    <hr />
