  ...
  //Water sources workings
    ...
    return (
        <div className="main-page">
            <h1 className="heading-tertiary">Metering</h1>
            <div className='table-section'>
                <div className="add__data add_water_source">
                    <input type="button" className="btn btn__add" onClick={ handleModal } value="Add water meter"/>
                </div>
            ...
            <Modal ref={modalRefEdit}>
                <fieldset>
                    <legend style={ { textAlign: "center" } }><h4 style={ { margin: "0 .5rem" } }>Edit water meter</h4></legend>
                    <hr />
                    <div className="registration__section" id="registration__section">
                        <form htmlFor="registration_form" className="registration__form" method="POST" onSubmit={ (e, id) => submitEditHandler(e, id) }>
                            ...
                            <input type="text"
                                ...
                                id="meter_number" name="meter_number"
            ...
            <Modal ref={ modalRefView }>
                <fieldset>
                    <legend style={ { textAlign: "center" } }><h4 style={ { margin: "0 .5rem" } }>Water meter</h4></legend>
                    {/* <hr /> */}
                    <div className="registration__section" id="registration__section">
                        {getSource}
                        <hr />
                    ...
                    <div className="registration__section" id="registration__section">
                        ...
                        <div className="form__group" id="form_group">
                            <input type="text"
                                ...
                                id="registered_to"
                                name="registered_to"
                                placeholder="name of the registered person..."
                            />
                        </div>
                        <div className="form__group" id="form_group">
                            <input type="text"
