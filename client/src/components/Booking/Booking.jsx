                    ...
                    <div className="book-right book__form">
                        <form action="#" className="form">
                            ...
                            <div className="form__group">
                                <input type="text" className="form__input" id="full__name" name="full_name" placeholder="Full name" required />
                                <label htmlFor="full__name" className="form__label">Full Name</label>
                            </div>
                            <div className="form__group">
                                <input type="email" className="form__input" id="email__address" name="email__address" placeholder="Email Address" required />
                                <label htmlFor="email__address" className="form__label">Email Address</label>
                            </div>
                            <div className="form__group">
                                <div className="form__radio--group">
                                    <input type="radio" className="form__radio--input" id="small" name="radio" selected />
